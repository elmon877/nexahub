...
export default function LoginPage() {
  ...
  // Pastikan komponen sudah ter-mount di client agar tidak ada error hydration
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  if (!mounted) return null; // Mencegah mismatch tampilan saat awal load
  ...
  return (
    <>
      ...
      <button
        ...
        style={{
          position: 'fixed', top: '24px', right: '24px', padding: '12px 28px',
          fontSize: '16px', fontWeight: 'bold', background: 'linear-gradient(135deg, #00d4aa 0%, #00a8ff 100%)',
          color: 'white', border: 'none', borderRadius: '12px', cursor: 'pointer',
          zIndex: 100, boxShadow: '0 4px 16px rgba(0, 212, 170, 0.4)'
        }}
      >
        Login
      </button>
      ...
      {isLoginOpen && (
        ...
        >
          <div style={{
            backgroundColor: 'rgba(20, 20, 30, 0.95)', padding: '40px', borderRadius: '24px',
